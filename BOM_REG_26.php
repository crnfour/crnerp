	   ...
	   <div class="col-2 col-s-12 menu">
		...
		<div class="col-10 col-s-12 menu">
			<div class="container_2">
				<center>
				<h1 class="sansserif">Stückliste Regulator 40-26</h1>
...
$qry="SELECT TN, TN_Index, Artikel, Lieferant, ID_Lief, Lieferant, Einzelpreis3, Lagerbestand, REG_Verwendung FROM artikel WHERE REG_Verwendung = 1";
